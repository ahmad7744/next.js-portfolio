...
import { SiFigma, SiAdobexd, SiAdobeillustrator,  SiAdobephotoshop, SiNextdotjs, SiFramer } from "react-icons/si";
    ...
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left ">
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          animate="show"
          exit="hidden"
           className="h2">Captivating <span className="text-accent ">Stories</span> birth mignificent designs. </motion.h2>
          <motion.p
